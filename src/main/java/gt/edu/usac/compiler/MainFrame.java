...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(350, 478));
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("ERRORES"));
    ...
    private void jMenuItem4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem4ActionPerformed
        ...
        try {
            ...
            LinkedList<String> erroresLexicos = lexer.getErrores();
            ...
            LinkedList<String> erroresSemanticos = parser.getErroresSemanticos();
            for (String erroreSemantico : erroresSemanticos) {
                sb.append(erroreSemantico).append("\n");
            }
            for (String string : Expresion.errores) {
                sb.append(string).append("\n");
            }
            cadenaErrores = sb.toString();
            PythonText.setText(sb.toString());
        } catch (IOException e) {
        } catch (Exception ex) {
            Logger.getLogger(MainFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
